...
import { EnvironmentalPlantData } from '../environt-ment-data';

const EnvironmentalPlant = () => {
  return (
    <div>
        <div
                className="w-full h-[60vh] flex items-center justify-center mb-14"
                style={{ backgroundImage: `url(${mainBg})`, backgroundSize: "cover" }}
              >
                <h2 className="text-4xl text-white">REFERENCE</h2>
              </div>

              <h2 className='text-center text-3xl font-bold mb-12'>환경플랜트</h2>
              <div className="flex items-center justify-center flex-wrap gap-9 m-auto container">
          {EnvironmentalPlantData.map((item, index) => (
...
export default EnvironmentalPlant
